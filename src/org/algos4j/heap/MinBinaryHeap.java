...
/**
 * Minimum binary heap, the top element is the minimum element in the heap.
 * <p>The elements of the heap queue must be {@link Comparable}</p>.
 * 
 * @author psajja
 *
 */
public class MinBinaryHeap<E extends Comparable<E>> extends AbstractBinaryHeap<E> {
